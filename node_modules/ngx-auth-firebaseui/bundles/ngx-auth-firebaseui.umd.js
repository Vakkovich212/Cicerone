(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@angular/router'), require('@angular/fire/auth'), require('@firebase/app'), require('@firebase/auth'), require('rxjs/operators'), require('@angular/fire/firestore'), require('@angular/material/snack-bar'), require('@angular/material/dialog'), require('@angular/common'), require('@angular/forms'), require('@angular/material/tabs'), require('@angular-material-extensions/password-strength'), require('@angular/animations'), require('rxjs'), require('rxjs/internal/operators'), require('@angular/common/http'), require('@angular/flex-layout'), require('@angular/fire'), require('@angular/material/button'), require('@angular/material/card'), require('@angular/material/checkbox'), require('@angular/material/chips'), require('@angular/material/divider'), require('@angular/material/icon'), require('@angular/material/input'), require('@angular/material/menu'), require('@angular/material/progress-bar'), require('@angular/material/progress-spinner'), require('@angular/material/tooltip'), require('@angular/platform-browser')) :
    typeof define === 'function' && define.amd ? define('ngx-auth-firebaseui', ['exports', '@angular/core', '@angular/router', '@angular/fire/auth', '@firebase/app', '@firebase/auth', 'rxjs/operators', '@angular/fire/firestore', '@angular/material/snack-bar', '@angular/material/dialog', '@angular/common', '@angular/forms', '@angular/material/tabs', '@angular-material-extensions/password-strength', '@angular/animations', 'rxjs', 'rxjs/internal/operators', '@angular/common/http', '@angular/flex-layout', '@angular/fire', '@angular/material/button', '@angular/material/card', '@angular/material/checkbox', '@angular/material/chips', '@angular/material/divider', '@angular/material/icon', '@angular/material/input', '@angular/material/menu', '@angular/material/progress-bar', '@angular/material/progress-spinner', '@angular/material/tooltip', '@angular/platform-browser'], factory) :
    (global = global || self, factory(global['ngx-auth-firebaseui'] = {}, global.ng.core, global.ng.router, global.ng.fire.auth, global.app, null, global.rxjs.operators, global.ng.fire.firestore, global.ng.material['snack-bar'], global.ng.material.dialog, global.ng.common, global.ng.forms, global.ng.material.tabs, global.passwordStrength, global.ng.animations, global.rxjs, global.rxjs['internal/operators'], global.ng.common.http, global.ng['flex-layout'], global.ng.fire, global.ng.material.button, global.ng.material.card, global.ng.material.checkbox, global.ng.material.chips, global.ng.material.divider, global.ng.material.icon, global.ng.material.input, global.ng.material.menu, global.ng.material['progress-bar'], global.ng.material['progress-spinner'], global.ng.material.tooltip, global.ng.platformBrowser));
}(this, (function (exports, core, router, auth, app, auth$1, operators, firestore, snackBar, dialog, common, forms, tabs, passwordStrength, animations, rxjs, operators$1, http, flexLayout, fire, button, card, checkbox, chips, divider, icon, input, menu, progressBar, progressSpinner, tooltip, platformBrowser) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    var AuthProcessService = /** @class */ (function () {
        ...
        AuthProcessService.prototype.listenToUserEvents = function () {
            var _this = this;
            this.user$ = this.afa.user.pipe(operators.tap(function (user) {
                _this.user = user;
            }));
        };
        /**
        ...
        AuthProcessService.prototype.getUserPhotoUrl = function () {
            ...
            if (!user) {
                ...
                return this.getPhotoPath(exports.Accounts.CHECK);
            }
            else if (user.isAnonymous) {
                return this.getPhotoPath(exports.Accounts.OFF);
            }
            else {
                return this.getPhotoPath(exports.Accounts.NONE);
            }
        };
    ...
    var LegalityDialogComponent = /** @class */ (function () {
        ...
        LegalityDialogComponent = __decorate([
            core.Component({
                ...
                styles: ["::ng-deep .mat-checkbox-label{display:-webkit-box;display:flex;flex-wrap:wrap}mat-dialog-content div{margin-top:1.5rem}mat-dialog-actions{margin-top:1rem}"]
            }),
    ...
    var AuthComponent = /** @class */ (function () {
        function AuthComponent(platformId, config, auth, authProcess, dialog, activatedRoute, changeDetectorRef) {
    ...
    var NgxAuthFirebaseuiRegisterComponent = /** @class */ (function () {
        ...
        NgxAuthFirebaseuiRegisterComponent.prototype.ngOnInit = function () {
            ...
            this.registerForm
                .controls
                .password
                .valueChanges.pipe(operators$1.takeUntil(this.unsubscribeAll))
                .subscribe(function () {
    ...
    exports.ɵd = NgxAuthFirebaseUIConfigToken;
    exports.ɵe = UserProvidedConfigToken;
    exports.ɵg = AuthProcessService;
    exports.ɵh = FirestoreSyncService;
    exports.ɵi = EmailConfirmationComponent;
